...
export class FormAssessmentComponent implements OnInit {
    ...
    private readonly tooltipWidths: number[][] = [
        [164, 174, 194, 194, 184], // первый вопрос
        [140, 156, 152, 184, 174], // второй вопрос
        [158, 140, 184, 188, 198], // третий вопрос
        [132, 132, 148, 164, 164], // четвертый вопрос
        [200, 144, 154, 176, 176], // пятый вопрос
        [164, 176, 148, 178, 276], // шестой вопрос
        [144, 154, 124, 108, 146], // седьмой вопрос
        [164, 174, 132, 154, 154]  // восьмой вопрос
    ];
